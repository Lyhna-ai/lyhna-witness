...
lyhna_labels:
  ...
  - "NEEDS_EVIDENCE"
  - "DO_NOT_SEND"
claimed_system: "google_drive"
claimed_action: "share_with_client"
handoff_resource: "../handoffs/hermes-zapier.md"
---

# Step 2 — google_drive.share_with_client

**Agent claimed:** share_with_client in google_drive → "shared"
